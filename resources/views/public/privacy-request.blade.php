        ...
        <header class="mb-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <h1 class="mt-2 text-3xl font-semibold tracking-tight text-slate-950">Privacy request</h1>
                </div>
        ...
        <main class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            ...
            <div class="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
                ...
                <aside class="rounded-2xl border border-slate-200 bg-slate-50 p-5 text-sm text-slate-600">
                    ...
                    <p class="mt-3 leading-6">Email <a href="mailto:{{ $contactEmail }}" class="font-medium underline">{{ $contactEmail }}</a> and include your booking or reservation reference if you have it.</p>
